...
def calculate_hhi(weights_df: pd.DataFrame) -> float | None:
    """
...
def calculate_and_store_hhi(session: Session) -> list[dict]:
    """
    Value-weighted HHI using SYMBOLS + WIDE price matrix (latest row).
    """
